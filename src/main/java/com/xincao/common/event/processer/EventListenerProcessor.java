package com.xincao.common.event.processer;

import com.xincao.common.event.listener.IGameEventListener;
import java.util.List;
import com.xincao.common.event.core.EventDispatcher;
...
public class EventListenerProcessor implements BeanPostProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EventListenerProcessor.class);
    private final EventDispatcher internalDispatcherDispatcher;
